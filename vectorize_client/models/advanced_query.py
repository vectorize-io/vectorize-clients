...
class AdvancedQuery(BaseModel):
    ...
    """ # noqa: E501
    mode: Optional[StrictStr] = Field(default='vector', description="Query mode - text, vector, or hybrid")
    text_fields: Optional[List[StrictStr]] = Field(default=None, description="Fields to search in text mode", alias="text-fields")
    match_type: Optional[StrictStr] = Field(default=None, description="Text matching type", alias="match-type")
    text_boost: Optional[Union[StrictFloat, StrictInt]] = Field(default=1.0, description="Boost factor for text queries", alias="text-boost")
    filters: Optional[Dict[str, Any]] = Field(default=None, description="Filters to apply to the query (Elasticsearch-style filters)")
