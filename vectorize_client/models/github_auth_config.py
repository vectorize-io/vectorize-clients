...
class GITHUBAuthConfig(BaseModel):
    ...
    oauth_token: Annotated[str, Field(strict=True)] = Field(description="Personal Access Token. Example: Enter your GitHub personal access token", alias="oauth-token")
    __properties: ClassVar[List[str]] = ["name", "oauth-token"]

    @field_validator('oauth_token')
    def oauth_token_validate_regular_expression(cls, value):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "oauth-token": obj.get("oauth-token")
        })
        return _obj
