...
class DROPBOXOAUTHAuthConfig(BaseModel):
    """
    ...
    selection_details: StrictStr = Field(description="Connect Dropbox to Vectorize. Example: Authorize", alias="selection-details")
    edited_users: Optional[StrictStr] = Field(default=None, alias="editedUsers")
    reconnect_users: Optional[StrictStr] = Field(default=None, alias="reconnectUsers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reconnectUsers": obj.get("reconnectUsers")
        })
        return _obj
