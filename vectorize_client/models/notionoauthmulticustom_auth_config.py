...
class NOTIONOAUTHMULTICUSTOMAuthConfig(BaseModel):
    """
    ...
    client_id: StrictStr = Field(description="Notion Client ID. Example: Enter Client ID", alias="client-id")
    client_secret: StrictStr = Field(description="Notion Client Secret. Example: Enter Client Secret", alias="client-secret")
