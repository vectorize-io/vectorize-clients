...
class RetrieveContext(BaseModel):
    ...
    RetrieveContext
    """ # noqa: E501
    messages: List[RetrieveContextMessage]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "messages": [RetrieveContextMessage.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None
        })
        return _obj
