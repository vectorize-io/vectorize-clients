...
class OPENAIAuthConfig(BaseModel):
    """
    Authentication configuration for OpenAI
    """ # noqa: E501
    name: StrictStr = Field(description="Name. Example: Enter a descriptive name for your OpenAI integration")
    key: Annotated[str, Field(strict=True)] = Field(description="API Key. Example: Enter your OpenAI API Key")
