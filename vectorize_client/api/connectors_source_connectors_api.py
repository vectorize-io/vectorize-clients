...
class ConnectorsSourceConnectorsApi:
    ...
    def create_source_connector(
        ...
        create_source_connector_request_inner: Annotated[List[CreateSourceConnectorRequestInner], Field(min_length=1)],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param create_source_connector_request_inner: (required)
        :type create_source_connector_request_inner: List[CreateSourceConnectorRequestInner]
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._create_source_connector_serialize(
            ...
            create_source_connector_request_inner=create_source_connector_request_inner,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _create_source_connector_serialize(
        self,
        organization_id,
        create_source_connector_request_inner,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if create_source_connector_request_inner is not None:
            _body_params = create_source_connector_request_inner
