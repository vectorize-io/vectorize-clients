...
class ConnectorsAIPlatformsApi:
    ...
    def create_ai_platform_connector(
        ...
        create_ai_platform_connector_request_inner: Annotated[List[CreateAIPlatformConnectorRequestInner], Field(min_length=1)],
        ...
        :param create_ai_platform_connector_request_inner: (required)
        :type create_ai_platform_connector_request_inner: List[CreateAIPlatformConnectorRequestInner]
        ...
        _param = self._create_ai_platform_connector_serialize(
            ...
            create_ai_platform_connector_request_inner=create_ai_platform_connector_request_inner,
    ...
    def _create_ai_platform_connector_serialize(
        self,
        organization_id,
        create_ai_platform_connector_request_inner,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if create_ai_platform_connector_request_inner is not None:
            _body_params = create_ai_platform_connector_request_inner
    ...
    def update_ai_platform_connector(
        ...
        organization: StrictStr,
        aiplatform_id: StrictStr,
        update_aiplatform_connector_request: UpdateAiplatformConnectorRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param aiplatform_id: (required)
        :type aiplatform_id: str
        :param update_aiplatform_connector_request: (required)
        :type update_aiplatform_connector_request: UpdateAiplatformConnectorRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_ai_platform_connector_serialize(
            organization=organization,
            aiplatform_id=aiplatform_id,
            update_aiplatform_connector_request=update_aiplatform_connector_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _update_ai_platform_connector_serialize(
        ...
        organization,
        aiplatform_id,
        update_aiplatform_connector_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_aiplatform_connector_request is not None:
            _body_params = update_aiplatform_connector_request
