...
class ExtractionApi:
    ...
    def get_extraction_result_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ExtractionResultResponse]:
        """Get extraction result
    ...
    @validate_call
    def get_extraction_result_without_preload_content(
        self,
        organization: StrictStr,
        extraction_id: StrictStr,
        _request_timeout: Union[
    ...
    def _get_extraction_result_serialize(
        self,
        organization,
        extraction_id,
        _request_auth,
        ...
        if extraction_id is not None:
            _path_params['extractionId'] = extraction_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/org/{organization}/extraction/{extractionId}',
    ...
    def start_extraction(
        ...
        chunk_size: Optional[Union[StrictFloat, StrictInt]] = None,
        chunk_overlap: Optional[Union[StrictFloat, StrictInt]] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def _start_extraction_serialize(
        ...
        if chunking_strategy is not None:
            _form_params.append(('chunkingStrategy', chunking_strategy))
        if chunk_size is not None:
            _form_params.append(('chunkSize', chunk_size))
        if chunk_overlap is not None:
            _form_params.append(('chunkOverlap', chunk_overlap))
        # process the body parameter
