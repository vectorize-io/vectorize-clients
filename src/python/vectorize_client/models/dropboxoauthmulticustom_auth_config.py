...
class DROPBOXOAUTHMULTICUSTOMAuthConfig(BaseModel):
    ...
    app_key: SecretStr = Field(description="Dropbox App Key. Example: Enter App Key", alias="app-key")
    app_secret: SecretStr = Field(description="Dropbox App Secret. Example: Enter App Secret", alias="app-secret")
