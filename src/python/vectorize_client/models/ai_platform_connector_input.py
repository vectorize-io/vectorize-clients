...
class AIPlatformConnectorInput(BaseModel):
    """
    AI platform configuration
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for the AI platform")
    type: StrictStr = Field(description="Type of AI platform")
    config: Optional[Any] = Field(description="Configuration specific to the AI platform")
