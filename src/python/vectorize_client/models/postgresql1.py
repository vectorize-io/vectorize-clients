...
class Postgresql1(BaseModel):
    """
    Postgresql1
    """ # noqa: E501
    config: Optional[POSTGRESQLAuthConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": POSTGRESQLAuthConfig.from_dict(obj["config"]) if obj.get("config") is not None else None
        })
        return _obj
