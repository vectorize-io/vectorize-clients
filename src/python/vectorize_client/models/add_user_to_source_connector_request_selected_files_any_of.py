...
class AddUserToSourceConnectorRequestSelectedFilesAnyOf(BaseModel):
    """
    AddUserToSourceConnectorRequestSelectedFilesAnyOf
    """ # noqa: E501
    page_ids: Optional[List[StrictStr]] = Field(default=None, alias="pageIds")
    database_ids: Optional[List[StrictStr]] = Field(default=None, alias="databaseIds")
    __properties: ClassVar[List[str]] = ["pageIds", "databaseIds"]
