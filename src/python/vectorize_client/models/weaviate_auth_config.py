...
class WEAVIATEAuthConfig(BaseModel):
    """
    Authentication configuration for Weaviate
    """ # noqa: E501
    name: StrictStr = Field(description="Name. Example: Enter a descriptive name for your Weaviate integration")
    host: StrictStr = Field(description="Endpoint. Example: Enter your Weaviate Cluster REST Endpoint")
    api_key: Annotated[str, Field(strict=True)] = Field(description="API Key. Example: Enter your API key", alias="api-key")
    __properties: ClassVar[List[str]] = ["name", "host", "api-key"]
