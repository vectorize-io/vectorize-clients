...
class PipelineConfigurationSchema(BaseModel):
    ...
    """ # noqa: E501
    source_connectors: Annotated[List[PipelineSourceConnectorSchema], Field(min_length=1)] = Field(alias="sourceConnectors")
    destination_connector: PipelineDestinationConnectorSchema = Field(alias="destinationConnector")
    ai_platform_connector: PipelineAIPlatformConnectorSchema = Field(alias="aiPlatformConnector")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sourceConnectors": [PipelineSourceConnectorSchema.from_dict(_item) for _item in obj["sourceConnectors"]] if obj.get("sourceConnectors") is not None else None,
            "destinationConnector": PipelineDestinationConnectorSchema.from_dict(obj["destinationConnector"]) if obj.get("destinationConnector") is not None else None,
            "aiPlatformConnector": PipelineAIPlatformConnectorSchema.from_dict(obj["aiPlatformConnector"]) if obj.get("aiPlatformConnector") is not None else None,
