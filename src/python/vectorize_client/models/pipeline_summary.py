...
class PipelineSummary(BaseModel):
    ...
    ai_platforms: List[AIPlatformConnector] = Field(alias="aiPlatforms")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "aiPlatforms": [AIPlatformConnector.from_dict(_item) for _item in obj["aiPlatforms"]] if obj.get("aiPlatforms") is not None else None
        })
        return _obj
