...
class GetWorkspacesResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["workspaces", "nextToken"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetWorkspacesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetWorkspacesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "workspaces": [WorkspaceSchema.from_dict(_item) for _item in obj["workspaces"]] if obj.get("workspaces") is not None else None,
