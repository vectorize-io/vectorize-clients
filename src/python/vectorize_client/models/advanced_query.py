...
class AdvancedQuery(BaseModel):
    ...
    text_boost: Optional[Union[StrictFloat, StrictInt]] = Field(default=1, alias="text-boost")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "text-boost": obj.get("text-boost") if obj.get("text-boost") is not None else 1,
