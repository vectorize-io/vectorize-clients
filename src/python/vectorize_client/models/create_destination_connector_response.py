...
class CreateDestinationConnectorResponse(BaseModel):
    """
    CreateDestinationConnectorResponse
    """ # noqa: E501
    message: StrictStr
    connectors: List[CreatedDestinationConnector]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "connectors": [CreatedDestinationConnector.from_dict(_item) for _item in obj["connectors"]] if obj.get("connectors") is not None else None
        })
        return _obj
