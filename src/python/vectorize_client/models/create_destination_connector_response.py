...
class CreateDestinationConnectorResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["message", "connector"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "connector": CreatedDestinationConnector.from_dict(obj["connector"]) if obj.get("connector") is not None else None
        })
        return _obj
