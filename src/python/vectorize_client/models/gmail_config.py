...
class GMAILConfig(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["from-filter-type", "to-filter-type", "subject-filter-type", "label-filter-type", "from", "to", "subject", "start-date", "end-date", "max-results", "messages-to-fetch", "label-ids"]
