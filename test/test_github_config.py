...
class TestGITHUBConfig(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GITHUBConfig:
        """Test GITHUBConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GITHUBConfig`
        """
        model = GITHUBConfig()
        if include_optional:
            return GITHUBConfig(
