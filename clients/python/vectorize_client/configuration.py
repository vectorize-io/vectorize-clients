...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.vectorize.io/v1" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("vectorize_client")
        ...
        return [
            {
                ...
                'description': "Vectorize API to Manage RAG Pipelines",
            }
        ]
