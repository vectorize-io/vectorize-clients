...
class OrgOrganizationIdPipelinesPipelineIdMetricsGet200ResponseData(BaseModel):
    """
    OrgOrganizationIdPipelinesPipelineIdMetricsGet200ResponseData
    """ # noqa: E501
    document_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="documentCount")
    vector_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="vectorCount")
    last_updated: Optional[datetime] = Field(default=None, alias="lastUpdated")
    __properties: ClassVar[List[str]] = ["documentCount", "vectorCount", "lastUpdated"]
