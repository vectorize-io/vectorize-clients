...
class OrgOrganizationIdPipelinesPipelineIdEventsGet200ResponseData(BaseModel):
    """
    OrgOrganizationIdPipelinesPipelineIdEventsGet200ResponseData
    """ # noqa: E501
    items: Optional[List[OrgOrganizationIdPipelinesPipelineIdEventsGet200ResponseDataItemsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [OrgOrganizationIdPipelinesPipelineIdEventsGet200ResponseDataItemsInner.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
