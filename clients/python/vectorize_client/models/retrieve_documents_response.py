...
class RetrieveDocumentsResponse(BaseModel):
    ...
    """ # noqa: E501
    record: Optional[RetrieveDocumentsResponseRecord] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "record": RetrieveDocumentsResponseRecord.from_dict(obj["record"]) if obj.get("record") is not None else None
        })
        return _obj
