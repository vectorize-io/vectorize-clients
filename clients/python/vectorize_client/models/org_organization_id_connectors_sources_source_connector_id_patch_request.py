...
class OrgOrganizationIdConnectorsSourcesSourceConnectorIdPatchRequest(BaseModel):
    """
    OrgOrganizationIdConnectorsSourcesSourceConnectorIdPatchRequest
    """ # noqa: E501
    type: StrictStr
    config_doc: Optional[Dict[str, Any]] = Field(default=None, alias="configDoc")
    __properties: ClassVar[List[str]] = ["type", "configDoc"]
