...
class OrgOrganizationIdUploadsConnectorIdFilesGet200Response(BaseModel):
    """
    OrgOrganizationIdUploadsConnectorIdFilesGet200Response
    """ # noqa: E501
    files: Optional[List[OrgOrganizationIdUploadsConnectorIdFilesGet200ResponseFilesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "files": [OrgOrganizationIdUploadsConnectorIdFilesGet200ResponseFilesInner.from_dict(_item) for _item in obj["files"]] if obj.get("files") is not None else None
        })
        return _obj
