...
class OrgOrganizationIdPipelinesGet200Response(BaseModel):
    """
    OrgOrganizationIdPipelinesGet200Response
    """ # noqa: E501
    pipelines: Optional[List[OrgOrganizationIdPipelinesGet200ResponsePipelinesInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pipelines": [OrgOrganizationIdPipelinesGet200ResponsePipelinesInner.from_dict(_item) for _item in obj["pipelines"]] if obj.get("pipelines") is not None else None
        })
        return _obj
