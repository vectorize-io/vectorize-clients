...
class OrgOrganizationIdUploadsConnectorIdFilesGet200ResponseFilesInner(BaseModel):
    """
    OrgOrganizationIdUploadsConnectorIdFilesGet200ResponseFilesInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["fileName", "size", "lastModified"]
