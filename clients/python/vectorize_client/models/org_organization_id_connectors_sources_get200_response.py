...
class OrgOrganizationIdConnectorsSourcesGet200Response(BaseModel):
    """
    OrgOrganizationIdConnectorsSourcesGet200Response
    """ # noqa: E501
    source_connectors: Optional[List[OrgOrganizationIdConnectorsAiplatformsGet200ResponseFormattedConnectorsInner]] = Field(default=None, alias="sourceConnectors")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sourceConnectors": [OrgOrganizationIdConnectorsAiplatformsGet200ResponseFormattedConnectorsInner.from_dict(_item) for _item in obj["sourceConnectors"]] if obj.get("sourceConnectors") is not None else None
        })
        return _obj
