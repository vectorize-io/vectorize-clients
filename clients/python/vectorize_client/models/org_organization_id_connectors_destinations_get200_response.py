...
class OrgOrganizationIdConnectorsDestinationsGet200Response(BaseModel):
    """
    OrgOrganizationIdConnectorsDestinationsGet200Response
    """ # noqa: E501
    destination_connectors: Optional[List[OrgOrganizationIdConnectorsAiplatformsGet200ResponseFormattedConnectorsInner]] = Field(default=None, alias="destinationConnectors")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "destinationConnectors": [OrgOrganizationIdConnectorsAiplatformsGet200ResponseFormattedConnectorsInner.from_dict(_item) for _item in obj["destinationConnectors"]] if obj.get("destinationConnectors") is not None else None
        })
        return _obj
