...
class OrgOrganizationIdUploadsConnectorIdFilesDeleteRequest(BaseModel):
    """
    OrgOrganizationIdUploadsConnectorIdFilesDeleteRequest
    """ # noqa: E501
    file_name: StrictStr = Field(description="Name of the file to delete", alias="fileName")
