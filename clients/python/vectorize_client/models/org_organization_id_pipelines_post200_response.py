...
class OrgOrganizationIdPipelinesPost200Response(BaseModel):
    """
    OrgOrganizationIdPipelinesPost200Response
    """ # noqa: E501
    message: Optional[StrictStr] = None
    data: Optional[OrgOrganizationIdPipelinesPost200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": OrgOrganizationIdPipelinesPost200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
