...
class OrgOrganizationIdConnectorsDestinationsPost200Response(BaseModel):
    """
    OrgOrganizationIdConnectorsDestinationsPost200Response
    """ # noqa: E501
    message: Optional[StrictStr] = None
    connectors: Optional[List[OrgOrganizationIdConnectorsDestinationsPost200ResponseConnectorsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "connectors": [OrgOrganizationIdConnectorsDestinationsPost200ResponseConnectorsInner.from_dict(_item) for _item in obj["connectors"]] if obj.get("connectors") is not None else None
        })
        return _obj
