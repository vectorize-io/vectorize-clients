...
class OrgOrganizationIdConnectorsSourcesSourceConnectorIdPatch200Response(BaseModel):
    """
    OrgOrganizationIdConnectorsSourcesSourceConnectorIdPatch200Response
    """ # noqa: E501
    message: Optional[StrictStr] = None
    data: Optional[OrgOrganizationIdConnectorsSourcesSourceConnectorIdPatch200ResponseData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": OrgOrganizationIdConnectorsSourcesSourceConnectorIdPatch200ResponseData.from_dict(obj["data"]) if obj.get("data") is not None else None
        })
        return _obj
