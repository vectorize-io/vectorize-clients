...
class OrgOrganizationIdPipelinesPostRequest(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['pipeline', 'experiment']):
            raise ValueError("must be one of enum values ('pipeline', 'experiment')")
        return value
