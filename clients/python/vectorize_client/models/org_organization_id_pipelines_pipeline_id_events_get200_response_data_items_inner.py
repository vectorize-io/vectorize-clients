...
class OrgOrganizationIdPipelinesPipelineIdEventsGet200ResponseDataItemsInner(BaseModel):
    """
    OrgOrganizationIdPipelinesPipelineIdEventsGet200ResponseDataItemsInner
    """ # noqa: E501
    id: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    timestamp: Optional[datetime] = None
    details: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["id", "type", "timestamp", "details"]
